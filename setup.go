...
func setup(c *caddy.Controller) error {
	...
	dnsserver.GetConfig(c).AddPlugin(func(next plugin.Handler) plugin.Handler {
		return Blocker{Next: next, Rules: rules, Zones: zones}
	})
...
func blockParser(c *caddy.Controller) (map[string]Rule, plugin.Zones, error) {
